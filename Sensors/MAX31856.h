...
// WIP FAULTS stuff I don't need right now //
...
enum MAX31856_ColdJunction_E
{
    MAX31856_ColdJunction_ON = 0b00000000,
    MAX31856_ColdJunction_OFF = 0b00001000,
};
...
struct MAX31856_S
{
    ...
    enum MAX31856_ColdJunction_E ColdJunction;
...
void MAX31856_CombineSettingsAndSend(struct MAX31856_S *MAX31856)
{
    ...
    MAX31856->Configuration0Register = MAX31856->NoiseRejectionFilter | MAX31856->ConversionMode | MAX31856->ColdJunction;
...
struct MAX31856_S SetupMAX31856(int ChipSelectPin, enum MAX31856_ThermocoupleType_En Type, enum MAX31856_Unit_E Unit, enum MAX31856_ColdJunction_E Mode)
{
    ...
    MAX31856.Unit = Unit;
    MAX31856.ColdJunction = Mode;

    MAX31856.ConversionMode = MAX31856_ConversionMode_Automatic;
    MAX31856.NoiseRejectionFilter = MAX31856_NoiseRejectionFilter_60;
...
double MAX31856GetTemperature(struct MAX31856_S *MAX31856)
{
    ...
    //printf("\nTemp Bytes: B0: %d, B1: %d B2: %d, B3: %d;", (int)TEMPBUF[0], (int)TEMPBUF[1],(int)TEMPBUF[2],(int)TEMPBUF[3]);    //ADDED
...
// Returns the cold junction temperature with units based on MAX31856.Units
double MAX31856GetColdJunctionTemp(struct MAX31856_S *MAX31856)
{
    char TEMPBUF[4], SENDBUFF[4];
    int AssembledValue;
    ...
    AssembledValue = ((int)TEMPBUF[2]);
    AssembledValue += ((int)TEMPBUF[1])<<8;
   
    //printf("\nCJ bytes B0: %d, B1: %d, B2: %d, B3: %d\n", (int)TEMPBUF[0],TEMPBUF[1],TEMPBUF[2],TEMPBUF[3]);
    if(MAX31856->Unit == MAX31856_Unit_Fahrenheit)
        return (AssembledValue / 256.0) * 9.0/5.0 + 32.0;
    else
        return (AssembledValue / 256.0);
}
